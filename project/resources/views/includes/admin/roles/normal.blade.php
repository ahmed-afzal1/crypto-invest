...
@endif
  {{-- <li class="nav-item">
    <a class="nav-link" href="{{ route('admin.coupon.index') }}">
      ...
      <span>{{ __('Set Coupons') }}</span></a>
  </li> --}}
  @if(Auth::guard('admin')->user()->sectionCheck('Manage Orders'))
  <li class="nav-item">
...
@endif
@if(Auth::guard('admin')->user()->sectionCheck('Manage Products'))
  <li class="nav-item">
...
@endif
@if(Auth::guard('admin')->user()->sectionCheck('Author Level'))
   <li class="nav-item">
...
@endif
@if(Auth::guard('admin')->user()->sectionCheck('Social Setting'))
  <li class="nav-item">
...
@endif
  <li class="nav-item">
    <a class="nav-link" href="{{ route('admin.cache.clear') }}" ><i class="fas fa-sync"></i>{{ __('Clear Cache') }}</a>
  </li>
